...
public extension String {
    ...
    public func split(_ sepearators: [String]) -> [String] {
        return self.characters.split { sepearators.contains(String($0)) }.map({ String($0) })
    }
    ...
    public func pad(_ toCount: Int, with: Character = Character(" "), prepend: Bool = true) -> String {
        var result = self
