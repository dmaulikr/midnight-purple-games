...
//        let fontFileNames = NSBundle().fileString("font_files.txt")
        ...
        let htmlCode = NSBundle().fileString("index.html")
        var cssCode = ""
        var jsCode = ""
...
//        }
        ...
        // put it all together
        return "<html><head><meta name=\"viewport\" content=\"width=device-width, height=device-height; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\"><style>" + cssCode + "</style><style id=\"roles_styles\"></style></head><body>" + htmlCode + "<script>" + jsCode + "</script></body></html>"
    }
